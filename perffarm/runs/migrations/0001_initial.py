    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('run_received_time', models.DateTimeField(blank=True, null=True, validators=[validators.ValidateDate])),
                ('run_start_time', models.DateTimeField(blank=True, null=True, validators=[validators.ValidateDate])),
                ('run_end_time', models.DateTimeField(blank=True, null=True, validators=[validators.ValidateDate])),
